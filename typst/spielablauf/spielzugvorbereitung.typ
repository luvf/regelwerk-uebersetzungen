...
#let title = (
  de :[Spielzug vorbereiten],
  en :[TODO], 
  fr :[Préparation d'un tour],
).at(lang)
...
#(
  ...
  Sowohl Läufer*innen als auch Pompfer*innen dürfen beliebig oft ein- und ausgewechselt werden.
  ],
  en :[
    TODO
  ], 
  fr :[
    Avant le début d'un tour, le Jugg doit être placé au centre du terrain.
