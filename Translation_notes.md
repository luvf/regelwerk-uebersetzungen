...
# Introduction
- p1. Place the jugg in "the opposing goal". Players may hit other players (not only opposing)
...
# A.2 
 - durfen =>can (may ?)
 - sollen => should (must?)
 - Nicht Dürfen/ Ist Verboten
  translation forbiddent=> usage (cannot)
 - Dürfen Vs Könnnen =>can
 - Nicht Können, transalion overlaps previous words.
 - Sein and Betragen,Befinden are very close, can be translated by measure but will probably not be used
